...
//slider for volume or pitch shifting
//not working T_T
function addSlider(x,y) {
	console.log("Inside Slider Function");
	var slider = new MultiWidgets.SliderWidget();
	slider.setLocation(100,100);
	slider.setRange(0,10);
	//slider.maxVal(10);
	//slider.minVal(0);
	slider.setCurrentValue(5.0);
	root.addChild(slider);
	console.log("End SLider Function");
}

//resonant class
function audioPlay(file){
	//var fileHandler = new Resonant.AudioFileHandler();
	//fileHandler.readFile(file);
	//fileHandler.start();
	console.log("A sound should be played here eventually when cornerstone people get back to me about their shitty javascript wrapper");
}
